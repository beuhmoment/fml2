...
from flaskshop.models import User, Post, Product, Cart, ContactUs, MyAdminIndexView, MyModelView
...
def add_to_cart(product_id):
    product = Product.query.get_or_404(product_id)
    cart = Cart(product_id=product_id, product_name=product.name, qty=1, owner_id=current_user.id)
